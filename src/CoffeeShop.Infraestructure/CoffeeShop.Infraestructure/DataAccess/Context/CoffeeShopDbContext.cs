...
namespace CoffeeShop.Infraestructure.DataAccess.Context;
...
public partial class CoffeeShopDbContext : DbContext
{
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        modelBuilder.Entity<EsnEmailServicoNotificacao>(entity =>
        {
            ...
            entity.Property(e => e.EmailUsrId).HasColumnName("email_usr_id");

            entity.HasOne(d => d.EmailUsr).WithMany(p => p.EsnEmailServicoNotificacaos)
                .HasForeignKey(d => d.EmailUsrId)
        ...
        modelBuilder.Entity<ProProduto>(entity =>
        {
            ...
            entity.Property(e => e.CafNmSubtitle)
                .HasMaxLength(255)
                .IsUnicode(false)
                .HasColumnName("caf_nm_subtitle");
            entity.Property(e => e.CafNmTitle)
                .HasMaxLength(255)
                .IsUnicode(false)
                .HasColumnName("caf_nm_title");
        ...
        modelBuilder.Entity<UsrUsuario>(entity =>
        {
            ...
            entity.Property(e => e.UsrEmailId).HasColumnName("usr_email_id");
            ...
            entity.HasOne(d => d.UsrEmail).WithMany(p => p.UsrUsuarios)
                .HasForeignKey(d => d.UsrEmailId)
                .OnDelete(DeleteBehavior.ClientSetNull)
